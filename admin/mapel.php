			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="mapel.php" class="active"><i class="lnr lnr-book"></i> <span>Mata Pelajaran</span></a></li>
				...
				<div class="container-fluid">
					<div class="panel panel-headline">
						...
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Mengelola data Mata Pelajaran</p>
						...
						<div class="panel-body">
							...
							<br />
							<form method="GET" action="mapel.php" style="padding:10px 0px;">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									if (isset($_GET['cari'])) {
										...
										$result = mysqli_query($koneksi, "SELECT * FROM mapel WHERE mata_pelajaran like '%" . $cari . "%' LIMIT " . $limitStart . "," . $limit);
										...
										$result = mysqli_query($koneksi, "SELECT * FROM mapel LIMIT " . $limitStart . "," . $limit);
									...
									?>
										...
										<tr>
											...
											<td style="width: 200px; text-align:center;">
												...
												<a class="btn btn-danger" href="aksimapel.php?aksi=hapus&id=<?php echo $row['ID']; ?>" onclick="return confirm('Anda yakin akan menghapus data?')"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
										<!-- Modal Edit -->
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="aksimapel.php?aksi=edit&id=<?php echo $row['ID'];?>" method="post" role="form">
															<div class="form-group">
																<label for="pelajaran" class="col-form-label">Mata Pelajaran:</label>
																<input type="text" class="form-control" id="pelajaran" name="pelajaran" value="<?php echo $row['mata_pelajaran']; ?>">
															</div>
							...
							<div class="text-black">
								<ul class="pagination">
									...
									?>
										...
										if ($cari == "") {
										?>
											<li><a href="mapel.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
										<?php
										} else {
										?>
											<li><a href="mapel.php?cari=<?php echo $cari; ?>&page=<?php echo $LinkPrev; ?>">Previous</a></li>
									<?php
										}
									}
									?>
									...
									if ($cari == "") {
										$SqlQuery = mysqli_query($koneksi, "SELECT * FROM mapel");
									} else {
										//kondisi jika parameter kolom pencarian diisi
										$SqlQuery = mysqli_query($koneksi, "SELECT * FROM mapel WHERE mata_pelajaran LIKE '%$cari%'");
									}
									...
									for ($i = $startNumber; $i <= $endNumber; $i++) {
										...
										if ($cari == "") {
									?>
											<li<?php echo $linkActive; ?>><a href="mapel.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

											<?php
										} else {
											?>
												<li<?php echo $linkActive; ?>><a href="mapel.php?cari=<?php echo $cari; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
											<?php
										}
									}
											?>
											...
											?>
												...
												if ($cari == "") {
												?>
													<li><a href="mapel.php?page=<?php echo $linkNext; ?>">Next</a></li>
												<?php
												} else {
												?>
													<li><a href="mapel.php?cari=<?php echo $cari; ?>&page=<?php echo $linkNext; ?>">Next</a></li>
											<?php
												}
											}
											?>
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="aksimapel.php?aksi=tambah" method="post" role="form">
							<div class="form-group">
								<label for="jurupelajaranan" class="col-form-label">Mata Pelajaran:</label>
