                ...
                <div class="container-fluid">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            ...
                            <p class="panel-subtitle">Mengelola data Semester</p>
                        </div>
                        <div class="panel-body">
                            ...
                            <br />
                            <form method="GET" action="semester.php" style="padding:10px 0px;">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['cari'])) {
                                        ...
                                        $result = mysqli_query($koneksi, "SELECT * FROM semester WHERE semester like '%" . $cari . "%' OR tahun_ajaran like '%" . $cari . "%' LIMIT " . $limitStart . "," . $limit);
                                        ...
                                        $result = mysqli_query($koneksi, "SELECT * FROM semester LIMIT " . $limitStart . "," . $limit);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 200px; text-align:center;">
                                                ...
                                                <a class="btn btn-danger" href="aksisemester.php?aksi=hapus&id=<?php echo $row['ID']; ?>" onclick="return confirm('Anda yakin akan menghapus data?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <!-- Modal Edit -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="aksisemester.php?aksi=edit&id=<?php echo $row['ID']; ?>" method="post" role="form">
                                                            <div class="form-group">
                                                                <label for="semester" class="col-form-label">Semester:</label>
                                                                <select id="semester" name="semester" class="form-control">
                                                                    <option value="Ganjil" <?php if ($row['semester'] == "Ganjil") {
                                                                                                echo "selected";
                                                                                            } ?>>Ganjil</option>
                                                                    <option value="Genap" <?php if ($row['semester'] == "Genap") {
                                                                                                echo "selected";
                                                                                            } ?>>Genap</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="tahun" name="tahun" value="<?php echo $row['tahun_ajaran']; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select id="status" name="status" class="form-control">
                                                                    ...
                                                                    <option value="Tidak" <?php if ($row['status'] == "Tidak") {
                                                                                                echo "selected";
                                                                                            } ?>>Tidak</option>
                                                                </select>
                                                            </div>
                            ...
                            <div class="text-black">
                                <ul class="pagination">
                                    ...
                                    ?>
                                        ...
                                        if ($cari == "") {
                                        ?>
                                            <li><a href="semester.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
                                        <?php
                                        } else {
                                        ?>
                                            <li><a href="semester.php?cari=<?php echo $cari; ?>&page=<?php echo $LinkPrev; ?>">Previous</a></li>
                                    <?php
                                        }
                                    }
                                    ?>
                                    ...
                                    if ($cari == "") {
                                        $SqlQuery = mysqli_query($koneksi, "SELECT * FROM semester");
                                    } else {
                                        //kondisi jika parameter kolom pencarian diisi
                                        $SqlQuery = mysqli_query($koneksi, "SELECT * FROM semester WHERE semester LIKE '%$cari%' OR tahun_ajaran LIKE '%$cari%'");
                                    }
                                    ...
                                    for ($i = $startNumber; $i <= $endNumber; $i++) {
                                        ...
                                        if ($cari == "") {
                                    ?>
                                            <li<?php echo $linkActive; ?>><a href="semester.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

                                            <?php
                                        } else {
                                            ?>
                                                <li<?php echo $linkActive; ?>><a href="semester.php?cari=<?php echo $cari; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                            <?php
                                        }
                                    }
                                            ?>
                                            ...
                                            ?>
                                                ...
                                                if ($cari == "") {
                                                ?>
                                                    <li><a href="semester.php?page=<?php echo $linkNext; ?>">Next</a></li>
                                                <?php
                                                } else {
                                                ?>
                                                    <li><a href="semester.php?cari=<?php echo $cari; ?>&page=<?php echo $linkNext; ?>">Next</a></li>
                                            <?php
                                                }
                                            }
                                            ?>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="aksisemester.php?aksi=tambah" method="post" role="form">
                            <div class="form-group">
                                <label for="semester" class="col-form-label">Semester:</label>
                                <select id="semester" name="semester" class="form-control">
