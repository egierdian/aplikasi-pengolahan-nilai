			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="jurusan.php" class="active"><i class="lnr lnr-file-empty"></i> <span>Jurusan</span></a></li>
				...
				<div class="container-fluid">
					<div class="panel panel-headline">
						...
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Mengelola data Jurusan</p>
						...
						<div class="panel-body">
							...
							<br />
							<form method="GET" action="jurusan.php" style="padding:10px 0px;">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									if (isset($_GET['cari'])) {
										...
										$result = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE nama_jurusan like '%" . $cari . "%' LIMIT " . $limitStart . "," . $limit);
										...
										$result = mysqli_query($koneksi, "SELECT * FROM jurusan LIMIT " . $limitStart . "," . $limit);
									...
									?>
										...
										<tr>
											...
											<td style="width: 200px; text-align:center;">
												...
												<a class="btn btn-danger" href="aksijurusan.php?aksi=hapus&id=<?php echo $row['ID']; ?>" onclick="return confirm('Anda yakin akan menghapus data?')"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
										<!-- Modal Edit -->
											...
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="aksijurusan.php?aksi=edit&id=<?php echo $row['ID'];?>" method="post" role="form">
															<div class="form-group">
																<label for="jurusan" class="col-form-label">Nama Jurusan:</label>
																<input type="text" class="form-control" id="jurusan" name="jurusan" value="<?php echo $row['nama_jurusan']; ?>">
															</div>
							...
							<div class="text-black">
								<ul class="pagination">
									...
									?>
										...
										if ($cari == "") {
										?>
											<li><a href="jurusan.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
										<?php
										} else {
										?>
											<li><a href="jurusan.php?cari=<?php echo $cari; ?>&page=<?php echo $LinkPrev; ?>">Previous</a></li>
									<?php
										}
									}
									?>
									...
									if ($cari == "") {
										$SqlQuery = mysqli_query($koneksi, "SELECT * FROM jurusan");
									} else {
										//kondisi jika parameter kolom pencarian diisi
										$SqlQuery = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE nama_jurusan LIKE '%$cari%'");
									}
									...
									for ($i = $startNumber; $i <= $endNumber; $i++) {
										...
										if ($cari == "") {
									?>
											<li<?php echo $linkActive; ?>><a href="jurusan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

											<?php
										} else {
											?>
												<li<?php echo $linkActive; ?>><a href="jurusan.php?cari=<?php echo $cari; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
											<?php
										}
									}
											?>
											...
											?>
												...
												if ($cari == "") {
												?>
													<li><a href="jurusan.php?page=<?php echo $linkNext; ?>">Next</a></li>
												<?php
												} else {
												?>
													<li><a href="jurusan.php?cari=<?php echo $cari; ?>&page=<?php echo $linkNext; ?>">Next</a></li>
											<?php
												}
											}
											?>
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="aksijurusan.php?aksi=tambah" method="post" role="form">
							<div class="form-group">
								<label for="jurusan" class="col-form-label">Nama Jurusan:</label>
