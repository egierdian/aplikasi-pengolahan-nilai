			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/" class=""><i class="lnr lnr-book"></i> <span>Buku</span></a></li>
						<li><a href="/" class=""><i class="lnr lnr-file-empty"></i> <span>Transaksi</span></a></li>
						<li><a href="/" class=""><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="container-fluid">
					<div class="panel panel-headline">
						...
						<div class="panel-heading">
							<h3 class="panel-title">Pengolahan Nilai</h3>
